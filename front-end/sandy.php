...
<html lang="en">
  <head>
	<title>Internet Outage DB</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="Internet Outage DB">
	...
	<?php
		...
		$conn = new mysqli($servername, $username, $password, "test_outage");
				...
				if (isset($_GET["from"]) && isset($_GET["to"]) && isset($_GET["set"])) {
					...
					if (isset($_GET["BGP"]) && urldecode($_GET["BGP"]) != "None") {
						...
						$sqlcount = "SELECT (count(*)/50) + 1 as totalpages
								...
								JOIN GeoInfo
								ON GeoInfo.IPBlock=substring(O.IPBlock,1,char_length(O.IPBlock)-3) AND 
		  ...
		  <div class="row">
			  <div class="col-md-2">
				  <form name="input" action="index.php" method="get">
						...
						<input id="submit" type="submit" value="Submit" class="btn btn-primary"> <a href="index.php" style="text-align:right;">Reset</a>
						</h4>
					</form>
					<br/>
